...
- **Ship** (`ship`: the player ships from the `ships` pack): a first flight model. W builds speed and S bleeds it; past a few metres a second the ship lifts off and is flown by hand, free of gravity: the mouse turns it and pitches it, A/D roll it, it never flies into the ground, and with the throttle off it settles and lands on its gear as a flyer. Fighters are quick, freighters ponderous. Interiors are converted but not entered yet.
